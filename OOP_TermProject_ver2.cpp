...
public:
    ...
    void onPrice(size_t idx, int price, double changeRate) override
    {
        if (!hasBought && cash >= price)
        {
            long buyAmount = (long)(cash * initialBuyRatio);
...
int main()
{
    ...
    // 샘플 가격 데이터 (30일)
    vector<int> prices = {
        70000, 71000, 69500, 68000, 65000, // 하락 시작
        62000, 58000, 55000, 53000, 50000, // 급락
        48000, 49000, 51000, 52000, 54000, // 바닥, 반등
        56000, 58000, 60000, 62000, 64000, // 회복
        65000, 67000, 68000, 70000, 72000, // 상승
        74000, 75000, 76000, 78000, 80000  // 신고가
    };
